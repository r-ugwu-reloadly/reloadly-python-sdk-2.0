...
class AirtimeTopupsController(BaseController):
    ...
    def __init__(self, config):
        super(AirtimeTopupsController, self).__init__(config)

    def reloadly_airtime_async_topup(self,
                                     accept,
                                     authorization,
                                     body):
        """Does a POST request to /topups-async.
        ...
        if _response.status_code == 400:
            raise APIException('Recipient phone number is not valid', _response)
    ...
    def reloadly_airtime_topup_status(self,
                                      ...
                                      authorization,
                                      transactionid):
        """Does a GET request to /topups/{transactionid}/status.
        ...
        Args:
            accept (string): TODO: type description here.
            authorization (string): TODO: type description here.
            transactionid (string): TODO: type description here.
        ...
        # Prepare query URL
        _url_path = '/topups/{transactionid}/status'
