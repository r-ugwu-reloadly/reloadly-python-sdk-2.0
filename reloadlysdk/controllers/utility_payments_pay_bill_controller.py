...
class UtilityPaymentsPayBillController(BaseController):

    """A Controller to access Endpoints in the reloadlysdk API."""
    def __init__(self, config):
        super(UtilityPaymentsPayBillController, self).__init__(config)

    def reloadly_utility_payments_pay_bill(self,
                                           accept,
                                           authorization,
                                           body):
        """Does a POST request to /pay.
        ...
        Args:
            ...
            body (ReloadlyUtilityPaymentsPayBillRequest): Request Payload
